...
<br>
   ...
   - **5.4: Deploy agent on Windows Server 2022**
     ...
     - After logging into the wazuh dashboard, deploy the agent following the steps indicated in the image below and then hit the button **d**:

<p align="center">
<img width="300" alt="Network Diagram" src="https://github.com/user-attachments/assets/d4e4da42-b979-432c-a39f-8d0aa15bf3a8">
</p>

   <img width="950" alt="image" src="https://github.com/user-attachments/assets/412eeb7d-b1e0-4516-a94f-e23db95c5203">
